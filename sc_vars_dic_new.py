{'ra': {'varname': 'ra',
 ...
 'administrative_level': {'varname': 'administrative_level',
  ...
  'section': 'Social Complexity',
  'subsection': 'Hierarchical Complexity',
  'col1': {'colname': 'administrative_level',
   'dtype': ['CharField', 'Select'],
   'varname': 'administrative_level',
   'col_exp': 'The absence or presence of administrative level for a polity.',
 ...
 'religious_level': {'varname': 'religious_level',
  ...
  'section': 'Social Complexity',
  'subsection': 'Hierarchical Complexity',
  'col1': {'colname': 'religious_level',
   'dtype': ['CharField', 'Select'],
   'varname': 'religious_level',
   'col_exp': 'The absence or presence of religious level for a polity.',
   'choices': 'ABSENT_PRESENT_CHOICES'}},
 'military_level': {'varname': 'military_level',
  ...
  'section': 'Social Complexity',
  'subsection': 'Hierarchical Complexity',
  'col1': {'colname': 'military_level',
   'dtype': ['CharField', 'Select'],
   'varname': 'military_level',
   'col_exp': 'The absence or presence of military level for a polity.',
   'choices': 'ABSENT_PRESENT_CHOICES'}},
